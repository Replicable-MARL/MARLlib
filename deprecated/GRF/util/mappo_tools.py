...
def centralized_critic_postprocessing(policy,
    ...
    if (pytorch and hasattr(policy, "compute_central_vf")) or \
        ...
        sample_batch["vf_preds"] = policy.compute_central_vf(
            convert_to_torch_tensor(sample_batch["obs"], policy.device),
...
def loss_with_central_critic(policy, model, dist_class, train_batch):
    ...
    model.value_function = lambda: policy.model.central_value_function(train_batch["obs"], train_batch["opponent_action"])
