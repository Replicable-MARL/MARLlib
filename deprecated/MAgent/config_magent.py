...
def get_train_parser():
    ...
    parser.add_argument(
        "--run",
        choices=["QMIX", "VDN", "R2D2", "PG", "A2C", "A3C", "MAA2C", "PPO", "MAPPO", "COMA", "MIX-VDA2C", "SUM-VDA2C", "MIX-VDPPO", "SUM-VDPPO", "HAPPO"],
        # "APPO" "IMPALA"
        default="HAPPO",
    ...
    parser.add_argument(
        "--map",
        choices=["adversarial_pursuit", "battle", "battlefield", "combined_arms", "gather", "tiger_deer"],
        default="battlefield",
        help="Maps should be registered")
    parser.add_argument(
        "--neural-arch",
        choices=["CNN_LSTM", "CNN_GRU"],
        type=str,
        default="CNN_LSTM",
