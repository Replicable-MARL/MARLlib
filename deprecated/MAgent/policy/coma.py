...
from MAgent.util.mappo_tools import *
from MAgent.util.maa2c_tools import *
from MAgent.util.coma_tools import loss_with_central_critic_coma, central_vf_stats_coma, COMATorchPolicy
    ...
    config = {
        "model": {
            ...
            "custom_model_config": {
                ...
                "mini_channel_dim": env_config["mini_channel_dim"],
                "coma": True
            },
        },
    }
