...
from IndependentLearning.policy.pg_a2c_a3c import run_pg_a2c_a3c
from IndependentLearning.policy.ppo import run_ppo
from IndependentLearning.models.universal_model import Universal_Model
from IndependentLearning.envs import REGISTRY
...
if __name__ == "__main__":
    ...
    register_env(config_dict["env"] + "_" + config_dict["env_args"]["map_name"],
                 lambda _: REGISTRY[config_dict["env"]](config_dict["env_args"]))

    test_env = REGISTRY[config_dict["env"]](config_dict["env_args"])
    ...
    results = policy_function_dict[config_dict["algorithm"]](config_dict, common_config, env_info_dict, stop)
