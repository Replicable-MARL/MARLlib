...
- **Part II. Environment**: available environments with the descrption
- **Part III. Baseline Algorithms**: implemented baseline MARL algorithnms cover **independent learning / centralized critic / value decompostion**
...
| VDN | Cooperative | No | Discrete | Value Decompostion |
| QMIX  | Cooperative | Yes | Discrete | Value Decompostion |
| VDAC  | Cooperative | Yes | Both | Value Decompostion |
| VDPPO | Cooperative | Yes | Both | Value Decompostion |
...
**(Note: this is not a comprehensive list. Only representitive paper are selected.)**
